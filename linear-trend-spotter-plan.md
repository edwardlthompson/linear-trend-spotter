...
|--------|-----------------|
| [§3.1 — Top-Level Layout](linear-trend-spotter-spec.md#31-top-level-layout) | Complete file tree and purpose table |
| [§3.3 — Archived Artifacts](linear-trend-spotter-spec.md#33-archived-artifacts) | Archive naming convention, daily increment rules |
| [§3.4 — Runtime Data Files](linear-trend-spotter-spec.md#34-runtime-data-files) | Files that MUST be gitignored |
| [§9.2 — Secrets Management](linear-trend-spotter-spec.md#92-secrets-management) | `.env.example` template content |
| [§9.3 — Tunable Parameters](linear-trend-spotter-spec.md#93-tunable-parameters) | All config keys and defaults for `config_json.example` |
| [§9.4 — Configuration File Format](linear-trend-spotter-spec.md#94-configuration-file-format) | `config.json` structure |
| [§1.5 — Reference Documents](linear-trend-spotter-spec.md#15-reference-documents) | `3rd-party-map.json` location |
...
| Source | Sections / Files |
|--------|-----------------|
| [§3.2 — Source Package Layout](linear-trend-spotter-spec.md#32-source-package-layout) | Key exports table for all sub-packages |
| [§9.1 — Configuration Architecture](linear-trend-spotter-spec.md#91-configuration-architecture) | Settings class design |
| [§9.3 — Tunable Parameters](linear-trend-spotter-spec.md#93-tunable-parameters) | All 17 parameter keys with types and defaults |
| [§7.2 — CoinGecko](linear-trend-spotter-spec.md#72-coingecko) | Client naming and behavior |
| [§8.1 — Primary Database](linear-trend-spotter-spec.md#81-primary-database--scannerdb) | Database naming |
| [§14.2 — Caching Strategy](linear-trend-spotter-spec.md#142-caching-strategy) | Cache class naming |
...
| Source | Sections / Files |
|--------|-----------------|
| [§8.1 — Primary Database — `scanner.db`](linear-trend-spotter-spec.md#81-primary-database--scannerdb) | `active_coins`, `scan_history`, `price_cache` table definitions |
| [§8.2 — Exchange Listings Database — `exchanges.db`](linear-trend-spotter-spec.md#82-exchange-listings-database--exchangesdb) | `exchange_listings`, `exchange_metadata`, `listing_cache` table definitions |
| [§8.3 — Mapping Database — `mappings.db`](linear-trend-spotter-spec.md#83-mapping-database--mappingsdb) | `symbol_mapping`, `mapping_metadata` table definitions |
| [§7.5 — Rate Limit Strategy](linear-trend-spotter-spec.md#75-rate-limit-strategy) | Full rate limiter behavioral spec |
| [§13.1 — API Failures](linear-trend-spotter-spec.md#131-api-failures) | Retry strategy, circuit breaker behavior |
| [§13.2 — Database Errors](linear-trend-spotter-spec.md#132-database-errors) | SQLite locked retry strategy |
...
| Source | Sections / Files |
|--------|-----------------|
| [§4.3 — Data Flow](linear-trend-spotter-spec.md#43-data-flow) | Progressive dict enrichment scheme |
| [§5.1 — Pipeline Overview](linear-trend-spotter-spec.md#51-pipeline-overview) | All 10 stages table |
| [§5.2 — Stage 1](linear-trend-spotter-spec.md#52-stage-1--coinmarketcap-bulk-fetch) through [§5.11 — Stage 10](linear-trend-spotter-spec.md#511-stage-10--notification-delivery) | Detailed stage specs |
| [§6.1 — Purpose](linear-trend-spotter-spec.md#61-purpose) through [§6.3 — Score Interpretation](linear-trend-spotter-spec.md#63-score-interpretation) | Full uniformity algorithm |
| [§5.5 — Stage 4 — Gain Filter](linear-trend-spotter-spec.md#55-stage-4--gain-filter) | Gain thresholds and stablecoin list |
...
| Source | Sections / Files |
|--------|-----------------|
| [§10.1 — Entry Notifications](linear-trend-spotter-spec.md#101-entry-notifications) | Exact caption format with emojis, HTML structure, CMC URL, exchange volume lines |
| [§10.2 — Exit Notifications](linear-trend-spotter-spec.md#102-exit-notifications) | Exact exit message format |
| [§10.3 — Telegram Bot Commands](linear-trend-spotter-spec.md#103-telegram-bot-commands) | `/status`, `/list`, `/help` — command names and response descriptions |
| [§5.11 — Stage 10](linear-trend-spotter-spec.md#511-stage-10--notification-delivery) | Notification delivery flow |
...
| Source | Sections / Files |
|--------|-----------------|
| [§12.1 — Logging Architecture](linear-trend-spotter-spec.md#121-logging-architecture) | Two-handler setup, format strings, rotation (10 MB × 5 backups) |
| [§12.2 — Log Files](linear-trend-spotter-spec.md#122-log-files) | `trend_scanner.log`, `bot_output.log` |
| [§12.3 — Scan Metrics](linear-trend-spotter-spec.md#123-scan-metrics) | All required counters: total fetched, eliminated per stage, API calls per service, cache hit/miss, wall-clock per stage, total duration |
| [§11.1 — Scheduled Tasks](linear-trend-spotter-spec.md#111-scheduled-tasks) | Cron schedule table |
| [§11.2 — Scan Locking](linear-trend-spotter-spec.md#112-scan-locking) | File lock behavior |
| [§14.1 — Scan Profile](linear-trend-spotter-spec.md#141-scan-profile) | Expected performance characteristics |
