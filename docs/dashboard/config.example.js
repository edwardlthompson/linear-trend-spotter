/** Copy to config.js for GitHub Pages builds and set your public snapshot URL. */
window.__SNAPSHOT_URL__ = "https://YOUR-RENDER-SERVICE.onrender.com/qualified_public_snapshot.json";
