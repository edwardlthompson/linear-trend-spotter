...
| CMC resolve + web push + active ranking + weekly digest (I2 steps) | `scanner/cmc_resolve.py`, `scanner/web_push_notify.py`, `scanner/active_ranking.py`, `scanner/weekly_digest.py` |
