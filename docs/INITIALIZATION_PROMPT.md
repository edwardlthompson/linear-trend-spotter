...
> **Status:** Reference-only. This project was bootstrapped from `agent-project-bootstrap` on 2026-06-13. Use `docs/FOR_AGENTS.md` and `BUILD_PLAN.md` for ongoing agent sessions.
...
**Purpose & Goals:** Crypto exchange scanner with backtesting and static PWA dashboard
