...
class Settings:
    ...
    @staticmethod
    def _env_str(name: str, fallback: Any) -> str:
        raw = os.getenv(name)
    ...
    def ntfy_enabled(self) -> bool:
        return self._env_bool('NTFY_ENABLED', self._config.get('NTFY_ENABLED', False))

    @property
    def ntfy_base_url(self) -> str:
        return self._env_str('NTFY_BASE_URL', self._config.get('NTFY_BASE_URL', 'https://ntfy.sh'))

    @property
    def ntfy_topic(self) -> str:
        return self._env_str('NTFY_TOPIC', self._config.get('NTFY_TOPIC', ''))

    @property
    def ntfy_token(self) -> str:
        return self._env_str('NTFY_TOKEN', self._config.get('NTFY_TOKEN', ''))

    @property
    def ntfy_priority(self) -> str:
        raw = self._env_str('NTFY_PRIORITY', self._config.get('NTFY_PRIORITY', 'default')).lower()
        return raw if raw in ('min', 'low', 'default', 'high', 'max', 'urgent') else 'default'

    @property
    def ntfy_dashboard_url(self) -> str:
        return self._env_str('NTFY_DASHBOARD_URL', self._config.get('NTFY_DASHBOARD_URL', ''))
