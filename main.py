...
def _close_scan_resources(*resources):
...
def _publish_public_snapshot(
    *,
    ...
    """Write/relay the public snapshot even when there are no qualified coins."""
...
def _finalize_zero_qualified_scan(
    *,
    ...
    app_logger.info("\n🔄 Finalizing healthy zero-qualified scan...")
...
def run_scanner():
    ...
    try:
        ...
        if not gain_qualified:
            ...
            _close_scan_resources(tv_mapper, exchange_db, cg_mapper, cache)
            return
