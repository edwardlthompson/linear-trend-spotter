...
def _finalize_zero_qualified_scan(
    *,
    ...
    coins_with_cg_ids_symbols: set[str] | None = None,
) -> None:
    """Finalize a healthy scan that produced no current qualified coins."""
    app_logger.info("\n🔄 Finalizing zero-qualified scan...")
            ...
            try:
                ...
                write_public_qualified_snapshot(
                    ...
                    scan_health={
                        "scan_duration_s": round(wall_s, 2),
                        "coins_evaluated": len(all_symbols),
                        "errors_count": int(_metrics_error_total()),
                    },
