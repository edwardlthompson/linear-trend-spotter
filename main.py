...
def _error_count_from_metrics() -> int:
...
def _finalize_zero_qualified_scan(
    *,
    ...
    """Finalize a healthy scan that produced no qualified coins."""
    ...
    try:
        ...
        app_logger.warning(f"⚠️ Insights update failed: {insights_error}")
        ...
        try:
            ...
            write_public_qualified_snapshot(
                ...
                scan_health={
                    ...
                    "errors_count": _error_count_from_metrics(),
                },
                regime_gate=None,
