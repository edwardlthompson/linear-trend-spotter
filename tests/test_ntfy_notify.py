...
def _isolated_ntfy_env(monkeypatch) -> None:
    for key in NTFY_ENV_KEYS:
...
def test_ntfy_posts_from_render_env(monkeypatch) -> None:
    _cfg(
        monkeypatch,
        NTFY_ENABLED=False,
        ...
        NTFY_PRIORITY="default",
        NTFY_DASHBOARD_URL="https://config.invalid/dash",
    )
